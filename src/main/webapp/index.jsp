        ...
        <div id="about">
            ...
            <div id="hit">
                ...
                <p class="lead" style="font-size:24px;"> Здесь Вы сможете увидеть популярные тако с их начинкой.
                 Но сейчас здесь пусто, так как мы только открылись и не хотим Вас обманывать.
                 Здесь будут самые популярные тако, которые у нас заказывают, когда будет продано достаточное количество тако или через какое-то время.
